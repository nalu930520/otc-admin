  ...
  <div style="background:#f0f2f5;margin-top: -20px;">
    <div class="wscn-http404">
      <div class="pic-404">
        ...
        <img class="pic-404__child left" :src="imr404Cloud" alt="404">
        <img class="pic-404__child mid" :src="imr404Cloud" alt="404">
        <img class="pic-404__child right" :src="imr404Cloud" alt="404">
      </div>
      <div class="bullshit">
...
import imgNotFoundCloud from '@/assets/404_images/404_cloud.png'
import { Component, Vue } from 'vue-property-decorator'

@Component
export default class NotFoundPage extends Vue {
  img404 = imgNotFound
  imr404Cloud = imgNotFoundCloud
  get message() {
    return '特朗普说这个页面你不能进......'
  }
}
